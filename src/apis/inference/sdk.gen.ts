 ...
 * Delete an agent
 */
export const deleteAgentAgentsAgentIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentAgentsAgentIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, DeleteAgentAgentsAgentIdDeleteError, ThrowOnError>({
        url: '/agents/{agent_id}',
        ...options
    });
};
...
/**
 * Resubscribe Agent
 * Resubscribe to an inactive agent
 */
export const resubscribeAgentAgentsAgentIdResubscribePost = <ThrowOnError extends boolean = false>(options: Options<ResubscribeAgentAgentsAgentIdResubscribePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResubscribeAgentAgentsAgentIdResubscribePostResponse, ResubscribeAgentAgentsAgentIdResubscribePostError, ThrowOnError>({
