...
export const getSubscriptionTransactionsSubscriptionsSubscriptionIdTransactionsGet = <ThrowOnError extends boolean = false>(options: Options<GetSubscriptionTransactionsSubscriptionsSubscriptionIdTransactionsGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetSubscriptionTransactionsSubscriptionsSubscriptionIdTransactionsGetError, ThrowOnError>({
 ...
 * Get subscriptions by user address
 */
export const getSubscriptionByUserAddressSubscriptionsUserAddressGet = <ThrowOnError extends boolean = false>(options: Options<GetSubscriptionByUserAddressSubscriptionsUserAddressGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetSubscriptionByUserAddressSubscriptionsUserAddressGetError, ThrowOnError>({
